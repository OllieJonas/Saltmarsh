...
public class CommonInputMenus {
    ...
    private static ButtonBuilder<Boolean> yesNoBuilder(String identifier, MessageEmbed embed) {
        return InputMenu.Button.builder(identifier, embed, Boolean.class).buttons(List.of(
    ...
    public static InputMenu.Button<Boolean> YES_NO(String identifier, String title, String description, int skipIfNo) {
        return YES_NO(identifier, EmbedUtils.colour().setTitle(title).setDescription(description).build(), 1, skipIfNo);
    }

    public static InputMenu.Button<Boolean> YES_NO(String identifier, String title, String description, int skipIfYes, int skipIfNo) {
    ...
    public static InputMenu.Button<Boolean> YES_NO(String identifier, MessageEmbed embed, int skipIfYes, int skipIfNo) {
        return YES_NO(identifier, embed, skipIfYes, skipIfNo, __ -> {});
    }

    public static InputMenu.Button<Boolean> YES_NO(String identifier, String title, String description,
                                                   int skipIfNo, Consumer<EntryContext<Boolean>> onOption) {
    ...
    public static InputMenu.Button<Boolean> CONFIRMATION_SCREEN(String identifier, String title, String description) {
        return CONFIRMATION_SCREEN(identifier, EmbedUtils.colour().setTitle(title).setDescription(description).build(), 1, __ -> {}, __ -> {});
    }

    public static InputMenu.Button<Boolean> CONFIRMATION_SCREEN(String identifier, String title, String description, Consumer<EntryContext<Boolean>> onNo) {
        return CONFIRMATION_SCREEN(identifier, EmbedUtils.colour().setTitle(title).setDescription(description).build(), 1, __ -> {}, onNo);
    }

    public static InputMenu.Button<Boolean> CONFIRMATION_SCREEN(String identifier, MessageEmbed embed) {
