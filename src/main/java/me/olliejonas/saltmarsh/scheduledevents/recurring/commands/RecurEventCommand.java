...
public class RecurEventCommand extends Command {
    ...
    public InteractionResponses execute(Member executor, TextChannel channel, Map<String, OptionMapping> args, String aliasUsed) throws CommandFailedException {
        ...
        List<Button> eventButtons = events.stream()
                .filter(event -> !manager.isRecurring(event))
        ...
        InputEmbed embed = InputEmbed.builder()
                ...
                .onCompletion(results -> {
                    ...
                    manager.registerEventAsRecurring(event, RecurringEvent.of(event, frequency), guild, scheduledEventListener);
